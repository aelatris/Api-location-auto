--
-- Script de population de la base de données du service de livraison
--
...
INSERT INTO `autobd`.`reservation` (`code`, `utilisateur_id`, `voiture_id`, `date`) VALUES ('2', '3', '1', '2021-01-13');
INSERT INTO `autobd`.`reservation` (`code`, `utilisateur_id`, `voiture_id`, `date`) VALUES ('3', '2', '4', '2020-11-19');
INSERT INTO `autobd`.`reservation` (`code`, `utilisateur_id`, `voiture_id`, `date`) VALUES ('4', '1', '2', '2019-06-21');
